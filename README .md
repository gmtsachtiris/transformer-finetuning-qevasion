...
> Coursework project for **Artificial Intelligence II — Deep Learning for NLP** (BSc in Informatics & Telecommunications, NKUA), The dataset comes from SemEval 2026 Task 6.
